                ...
                <div class="panel-body">
                    <form class="form-horizontal" method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group{{ $errors->has('username') ? ' has-error' : '' }}">
                            <label for="reg_username" class="col-md-4 control-label">Name</label>

                            <div class="col-md-6">
                                <input id="reg_username" type="text" class="form-control" name="username" value="{{ old('username') }}" required autofocus>
